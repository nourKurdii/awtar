"""
Django settings for awtar project.
...
SECRET_KEY = "django-insecure-)qz_e&l*h-kj07m!36_umx(y57w_*vu+4@h((jsa3rj^dl_st="
...
WSGI_APPLICATION = "awtar.wsgi.application"
